...
`brookesia_agent_xiaozhi` 是为 ESP-Brookesia 生态系统提供的小智 AI 智能体实现，提供小智 API 集成以及面向 ESP-Brookesia 设备的统一智能体生命周期管理能力。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/agent/xiaozhi.html)。
