...
`brookesia_agent_coze` is a Coze agent implementation based on the ESP-Brookesia Agent Manager framework. It provides Coze API integration, WebSocket communication, and unified agent lifecycle management for ESP-Brookesia devices.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/agent/coze.html).
