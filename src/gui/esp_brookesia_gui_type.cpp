...
#include "esp_brookesia_gui_type.hpp"
...
bool StyleSize::calibrate(const StyleSize &parent)
{
    ...
    if (flags.enable_width_auto) {
        ...
        ESP_BROOKESIA_CHECK_VALUE_RETURN(width_percent, 1, 100, false, "Invalid width percent");
        width = (parent_w * width_percent) / 100;
    } else {
        ESP_BROOKESIA_CHECK_VALUE_RETURN(width, 1, parent_w, false, "Invalid width");
    }
    ...
    if (flags.enable_height_auto) {
        ...
        ESP_BROOKESIA_CHECK_VALUE_RETURN(height_percent, 1, 100, false, "Invalid Height percent");
        height = (parent_h * height_percent) / 100;
    } else {
        ESP_BROOKESIA_CHECK_VALUE_RETURN(height, 1, parent_h, false, "Invalid Height");
    }
...
bool StyleSize::calibrate(const StyleSize &parent, bool allow_zero)
{
    ...
    if (flags.enable_width_auto) {
        ...
        ESP_BROOKESIA_CHECK_VALUE_RETURN(width_percent, min_size, 100, false, "Invalid width percent");
        width = (parent_w * width_percent) / 100;
    } else {
        ESP_BROOKESIA_CHECK_VALUE_RETURN(width, min_size, parent_w, false, "Invalid width");
    }
    ...
    if (flags.enable_height_auto) {
        ...
        ESP_BROOKESIA_CHECK_VALUE_RETURN(height_percent, min_size, 100, false, "Invalid Height percent");
        height = (parent_h * height_percent) / 100;
    } else {
        ESP_BROOKESIA_CHECK_VALUE_RETURN(height, min_size, parent_h, false, "Invalid Height");
    }
...
process_height:
    ...
    if (flags.enable_height_percent) {
        ...
        ESP_BROOKESIA_CHECK_VALUE_RETURN(height, 1, parent->height, false, "Invalid height");
    }
...
{
    ESP_BROOKESIA_CHECK_NULL_RETURN(resource, false, "Invalid resource");
