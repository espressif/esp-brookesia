...
#if !ESP_BROOKESIA_CONF_LVGL_SCREEN_ENABLE_DEBUG_LOG
    ...
    LvObject(lv_obj_create(nullptr))
{
    ...
    ESP_BROOKESIA_CHECK_FALSE_EXIT(isValid(), "Create screen failed");

    ESP_BROOKESIA_CHECK_FALSE_EXIT(removeStyle(nullptr), "Remove style failed");
...
bool LvScreen::load()
{
    ...
    ESP_BROOKESIA_CHECK_FALSE_RETURN(isValid(), false, "Invalid screen");
