...
#if !ESP_BROOKESIA_CONF_CORE_APP_ENABLE_DEBUG_LOG
...
bool ESP_Brookesia_CoreApp::loadRecentScreen(void)
{
    ...
    ESP_BROOKESIA_CHECK_FALSE_RETURN(checkLvObjIsValid(_active_screen), false, "Invalid active screen");
    lv_scr_load(_active_screen);
...
bool ESP_Brookesia_CoreApp::enableAutoClean(void)
{
    ...
    ESP_BROOKESIA_CHECK_FALSE_RETURN(checkLvObjIsValid(last_screen), false, "Invalid last screen");
...
// {
//     ESP_BROOKESIA_CHECK_FALSE_RETURN((_temp_screen != nullptr) && checkLvObjIsValid(_temp_screen), false, "Invalid temp screen");
