 ...
 *
 */
class ESP_UI_PhoneApp: public ESP_UI_CoreApp {
public:
    friend class ESP_UI_PhoneHome;
     ...
     *
     */
    ESP_UI_PhoneApp(const ESP_UI_CoreAppData_t &core_data, const ESP_UI_PhoneAppData_t &phone_data);
     ...
     *
     */
    const ESP_UI_PhoneAppData_t &getInitData(void) const
    {
        return _init_data;
    }
     ...
     *
     */
    const ESP_UI_PhoneAppData_t &getActiveData(void) const
    {
        return _active_data;
    }
...
private:
    ...
    ESP_UI_PhoneAppData_t _init_data;
    ESP_UI_PhoneAppData_t _active_data;
    ESP_UI_RecentsScreenSnapshotConf_t _recents_screen_snapshot_conf;
};
// *INDENT-OFF*
