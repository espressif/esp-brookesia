 ...
 *
 */
class PhoneAppSquareline: public ESP_Brookesia_PhoneApp {
public:
    /**
     * @brief Get the singleton instance of PhoneAppSquareline
     *
     * @param use_status_bar Flag to show the status bar
     * @param use_navigation_bar Flag to show the navigation bar
     * @return Pointer to the singleton instance
     */
    static PhoneAppSquareline *getInstance(bool use_status_bar = false, bool use_navigation_bar = false);
...
private:
    static PhoneAppSquareline *_instance; // Singleton instance
};
