...
/* manager */
#define ESP_BROOKESIA_PHONE_1024_600_DARK_CORE_MANAGER_DATA() \
    {                                                  \
        .app = {                                       \
            .max_running_num = 3,                      \
        },                                             \
...
/* Core */
#define ESP_BROOKESIA_PHONE_1024_600_DARK_CORE_INFO_DATA_NAME    "1024x600 Drak"
#define ESP_BROOKESIA_PHONE_1024_600_DARK_CORE_DATA()                     \
    {                                                              \
