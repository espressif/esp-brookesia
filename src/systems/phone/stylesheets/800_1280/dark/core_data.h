...
LV_IMG_DECLARE(esp_brookesia_phone_800_1280_wallpaper_image_dark);

/* Home */
#define ESP_BROOKESIA_PHONE_800_1280_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                    \
        .background = {                                                                                  \
            .color = ESP_BROOKESIA_STYLE_COLOR(0x1A1A1A),                                                       \
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_800_1280_wallpaper_image_dark), \
        },                                                                                               \
        .text = {                                                                                        \
...
/* manager */
#define ESP_BROOKESIA_PHONE_800_1280_DARK_CORE_MANAGER_DATA() \
    {                                                  \
        .app = {                                       \
            .max_running_num = 3,                      \
        },                                             \
...
/* Core */
#define ESP_BROOKESIA_PHONE_800_1280_DARK_CORE_INFO_DATA_NAME    "800x1280 Drak"
#define ESP_BROOKESIA_PHONE_800_1280_DARK_CORE_DATA()                     \
    {                                                              \
