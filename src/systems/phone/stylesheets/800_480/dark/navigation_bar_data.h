...
LV_IMG_DECLARE(esp_brookesia_phone_800_480_navigation_bar_image_back);
LV_IMG_DECLARE(esp_brookesia_phone_800_480_navigation_bar_image_home);
LV_IMG_DECLARE(esp_brookesia_phone_800_480_navigation_bar_image_recents_screen);

#define ESP_BROOKESIA_PHONE_800_480_DARK_NAVIGATION_BAR_DATA()                                                      \
    {                                                                                                        \
        .main = {                                                                                            \
        ...
        .button = {                                                                                          \
            ...
            .icon_images = {                                                                                 \
                ESP_BROOKESIA_STYLE_IMAGE_RECOLOR_WHITE(&esp_brookesia_phone_800_480_navigation_bar_image_back),           \
                ESP_BROOKESIA_STYLE_IMAGE_RECOLOR_WHITE(&esp_brookesia_phone_800_480_navigation_bar_image_home),           \
                ESP_BROOKESIA_STYLE_IMAGE_RECOLOR_WHITE(&esp_brookesia_phone_800_480_navigation_bar_image_recents_screen), \
            },                                                                                               \
            .navigate_types = {                                                                              \
