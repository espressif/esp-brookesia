...
LV_IMG_DECLARE(esp_brookesia_phone_800_480_wallpaper_image_dark);
...
#define ESP_BROOKESIA_PHONE_800_480_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                   \
        .background = {                                                                                 \
            ...
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_800_480_wallpaper_image_dark), \
        },                                                                                              \
        .text = {                                                                                       \
