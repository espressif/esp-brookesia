...
constexpr ESP_Brookesia_AppLauncherIconData_t ESP_BROOKESIA_PHONE_800_480_DARK_APP_LAUNCHER_ICON_DATA()
{
    return {
        .main = {
            .size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(164),
            .layout_row_pad = 10,
        },
        .image = {
...
constexpr ESP_Brookesia_AppLauncherData_t ESP_BROOKESIA_PHONE_800_480_DARK_APP_LAUNCHER_DATA()
{
    return {
        .main = {
            .y_start = 0,
        ...
        .icon = ESP_BROOKESIA_PHONE_800_480_DARK_APP_LAUNCHER_ICON_DATA(),
        .flags = {
