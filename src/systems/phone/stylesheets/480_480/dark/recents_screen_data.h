...
LV_IMG_DECLARE(esp_brookesia_phone_480_480_recents_screen_trash_image);

#define ESP_BROOKESIA_PHONE_480_480_DARK_RECENTS_SCREEN_SNAPSHOT_DATA() \
    {                                                            \
...
#define ESP_BROOKESIA_PHONE_480_480_DARK_RECENTS_SCREEN_DATA()                                    \
    {                                                                                      \
        .main = {                                                                          \
        ...
        .trash_icon = {                                                                    \
            ...
            .image = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_480_480_recents_screen_trash_image), \
        },                                                                                 \
        .flags = {                                                                         \
            .enable_memory = 1,                                                            \
