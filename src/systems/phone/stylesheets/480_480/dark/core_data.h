...
LV_IMG_DECLARE(esp_brookesia_phone_480_480_wallpaper_image_dark);
...
#define ESP_BROOKESIA_PHONE_480_480_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                   \
        .background = {                                                                                 \
            ...
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_480_480_wallpaper_image_dark), \
        },                                                                                              \
        .text = {                                                                                       \
