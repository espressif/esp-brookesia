...
constexpr ESP_Brookesia_RecentsScreenSnapshotData_t ESP_BROOKESIA_PHONE_720_1280_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()
{
    return {
...
constexpr ESP_Brookesia_RecentsScreenData_t ESP_BROOKESIA_PHONE_720_1280_DARK_RECENTS_SCREEN_DATA()
{
    return {
        .main = {
