...
/* Home */
#define ESP_BROOKESIA_PHONE_320_480_DARK_HOME_DATA()                                     \
    {                                                                             \
        .status_bar = {                                                           \
...
/* Manager */
#define ESP_BROOKESIA_PHONE_320_480_DARK_MANAGER_DATA()             \
    {                                                        \
...
/* Phone */
#define ESP_BROOKESIA_PHONE_320_480_DARK_STYLESHEET()               \
    {                                                        \
