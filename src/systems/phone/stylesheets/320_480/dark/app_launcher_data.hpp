...
constexpr ESP_Brookesia_AppLauncherIconData_t ESP_BROOKESIA_PHONE_320_480_DARK_APP_LAUNCHER_ICON_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_AppLauncherData_t ESP_BROOKESIA_PHONE_320_480_DARK_APP_LAUNCHER_DATA()
{
    return {
        .main = {
            .y_start = 0,
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 444),
        },
        .table = {
            .default_num = 3,
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 380),
        },
        .indicator = {
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 44),
        ...
        .icon = ESP_BROOKESIA_PHONE_320_480_DARK_APP_LAUNCHER_ICON_DATA(),
        .flags = {
