...
LV_IMG_DECLARE(esp_brookesia_phone_320_480_wallpaper_image_dark);

/* Home */
#define ESP_BROOKESIA_PHONE_320_480_DARK_CORE_HOME_DATA()                                      \
    {                                                                                   \
        .background = {                                                                 \
            .color = ESP_BROOKESIA_STYLE_COLOR(0x1A1A1A),                                      \
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_320_480_wallpaper_image_dark), \
        },                                                                              \
        .text = {                                                                       \
...
/* manager */
#define ESP_BROOKESIA_PHONE_320_480_DARK_CORE_MANAGER_DATA() \
    {                                                 \
        .app = {                                      \
            .max_running_num = 3,                     \
        },                                            \
...
/* Core */
#define ESP_BROOKESIA_PHONE_320_480_DARK_CORE_INFO_DATA_NAME    "320x480 Drak"
#define ESP_BROOKESIA_PHONE_320_480_DARK_CORE_DATA()                     \
    {                                                             \
        .name = ESP_BROOKESIA_PHONE_320_480_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(320, 480),          \
        .home = ESP_BROOKESIA_PHONE_320_480_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_320_480_DARK_CORE_MANAGER_DATA(), \
    }
