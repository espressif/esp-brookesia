...
/* Font */
#define ESP_UI_STYLE_FONT_SIZE_MIN    8
#define ESP_UI_STYLE_FONT_SIZE_MAX    48
 ...
 */
#define ESP_UI_STYLE_SIZE_RECT(w, h) \
    {                                \
        .width = w,                  \
        .height = h,                 \
    }
 ...
 */
#define ESP_UI_STYLE_SIZE_RECT_PERCENT(w_percent, h_percent) \
    {                                                        \
 ...
 * @param h The height in pixels
 */
#define ESP_UI_STYLE_SIZE_RECT_W_PERCENT(w_percent, h) \
    {                                                  \
        .height = h,                                   \
        .width_percent = w_percent,                    \
        .flags = {                                     \
 ...
 * @param h_percent The percentage of the parent height
 */
#define ESP_UI_STYLE_SIZE_RECT_H_PERCENT(w, h_percent) \
    {                                                  \
        .width = w,                                    \
        .height_percent = h_percent,                   \
        .flags = {                                     \
 ...
 */
#define ESP_UI_STYLE_SIZE_SQUARE(size) \
    {                                  \
        .width = size,                 \
        .height = size,                \
    }
 ...
 */
#define ESP_UI_STYLE_SIZE_SQUARE_PERCENT(percent) \
    {                                             \
 ...
 *        `ESP_UI_STYLE_FONT_*` macros.
 */
typedef struct {
    uint8_t size_px;                        /*!< Font size in pixels. The font size must be between
                                                 `ESP_UI_STYLE_FONT_SIZE_MIN` and `ESP_UI_STYLE_FONT_SIZE_MAX` */
 ...
 */
#define ESP_UI_STYLE_FONT_SIZE(size) \
    {                                \
        .size_px = size,             \
    }
 ...
 */
#define ESP_UI_STYLE_FONT_HEIGHT(h) \
    {                               \
        .height = h,                \
        .flags = {                  \
            .enable_height = 1,     \
 ...
 */
#define ESP_UI_STYLE_FONT_HEIGHT_PERCENT(percent) \
    {                                             \
        .height_percent = percent,                \
        .flags = {                                \
            .enable_height = 1,                   \
 ...
 *
 */
#define ESP_UI_STYLE_FONT_CUSTOM_SIZE(size, font) \
    {                                             \
        .size_px = size,                          \
        .font_resource = font,                    \
    }
 ...
 */
#define ESP_UI_STYLE_COLOR(color24) \
    {                               \
        .color = color24,           \
        .opacity = 255,             \
    }
 ...
 */
#define ESP_UI_STYLE_COLOR_WITH_OPACIRY(color24, opa) \
    {                                                 \
        .color = color24,                             \
        .opacity = opa,                               \
    }
 ...
 *        dimensions using the `ESP_UI_STYLE_IMAGE*` macros.
 *
 */
typedef struct {
    const void *resource;           /*!< Pointer to the image resource */
    ESP_UI_StyleColor_t recolor;    /*!< Color to recolor the image */
    struct {
 ...
 */
#define ESP_UI_STYLE_IMAGE(image) \
    {                             \
        .resource = image,        \
    }
 ...
 */
#define ESP_UI_STYLE_IMAGE_RECOLOR(image, color) \
    {                                            \
        .resource = image,                       \
        .recolor = ESP_UI_STYLE_COLOR(color),    \
        .flags = {                               \
            .enable_recolor = 1,                 \
        },                                       \
    }
 ...
 * @param image The image resource
 */
#define ESP_UI_STYLE_IMAGE_RECOLOR_WHITE(image)  \
    {                                            \
        .resource = image,                       \
        .recolor = ESP_UI_STYLE_COLOR(0xFFFFFF), \
        .flags = {                               \
            .enable_recolor = 1,                 \
        },                                       \
    }
 ...
 * @param image The image resource
 */
#define ESP_UI_STYLE_IMAGE_RECOLOR_BLACK(image) \
    {                                           \
        .resource = image,                      \
        .recolor = ESP_UI_STYLE_COLOR(0x000000),\
        .flags = {                              \
            .enable_recolor = 1,                \
        },                                      \
    }
