...
typedef struct {
    ...
    int id;
} ESP_UI_RecentsScreenSnapshotConf_t;
...
} ESP_UI_RecentsScreenSnapshotData_t;
...
typedef struct {
    ...
    struct {
        ...
        ESP_UI_StyleFont_t label_text_font;
        ESP_UI_StyleColor_t label_text_color;
        const char *label_unit_text;
    } memory;
    struct {
        ESP_UI_StyleSize_t main_size;
        uint16_t main_layout_column_pad;
        ESP_UI_RecentsScreenSnapshotData_t snapshot;
    } snapshot_table;
    struct {
