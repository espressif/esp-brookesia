...
#define AddressNearFull 0x926B
#define AddressReserveCapacity 0x926D
#define AddressSelfDischargeRate 0x9268
#define AddressSysDownSetVoltThreshold 0x9240
#define AddressSysDownClearVoltThreshold 0x9243
