...
constexpr ESP_Brookesia_CoreHomeData_t ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_HOME_DATA()
{
    return {
        .background = {
...
constexpr ESP_Brookesia_CoreManagerData_t ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_MANAGER_DATA()
{
    return {
        .app = {
            .max_running_num = 3,
...
constexpr const char *ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_INFO_DATA_NAME = "1280x800 Dark";

constexpr ESP_Brookesia_CoreData_t ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_DATA()
{
    return {
        .name = ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_INFO_DATA_NAME,
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(1280, 800),
        .home = ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_HOME_DATA(),
        .manager = ESP_BROOKESIA_PHONE_1280_800_DARK_CORE_MANAGER_DATA(),
    };
}
