...
constexpr ESP_Brookesia_StatusBarAreaData_t ESP_BROOKESIA_PHONE_1280_800_DARK_STATUS_BAR_AREA_DATA(int w_percent, ESP_Brookesia_StatusBarAreaAlign_t align)
{
    return {
...
constexpr ESP_Brookesia_StatusBarData_t ESP_BROOKESIA_PHONE_1280_800_DARK_STATUS_BAR_DATA()
{
    return {
        .main = {
