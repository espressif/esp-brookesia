...
constexpr ESP_Brookesia_RecentsScreenSnapshotData_t ESP_BROOKESIA_PHONE_1280_800_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()
{
    return {
...
constexpr ESP_Brookesia_RecentsScreenData_t ESP_BROOKESIA_PHONE_1280_800_DARK_RECENTS_SCREEN_DATA()
{
    return {
        .main = {
