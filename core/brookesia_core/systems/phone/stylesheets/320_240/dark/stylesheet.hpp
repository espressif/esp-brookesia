...
constexpr ESP_Brookesia_PhoneHomeData_t ESP_BROOKESIA_PHONE_320_240_DARK_HOME_DATA()
{
    return {
        .status_bar = {
            .data = ESP_BROOKESIA_PHONE_320_240_DARK_STATUS_BAR_DATA(),
...
constexpr ESP_Brookesia_PhoneManagerData_t ESP_BROOKESIA_PHONE_320_240_DARK_MANAGER_DATA()
{
    return {
...
constexpr ESP_Brookesia_PhoneStylesheet_t ESP_BROOKESIA_PHONE_320_240_DARK_STYLESHEET()
{
    return {
        .core = ESP_BROOKESIA_PHONE_320_240_DARK_CORE_DATA(),
        .home = ESP_BROOKESIA_PHONE_320_240_DARK_HOME_DATA(),
        .manager = ESP_BROOKESIA_PHONE_320_240_DARK_MANAGER_DATA(),
    };
}
