...
constexpr ESP_Brookesia_PhoneHomeData_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_HOME_DATA()
{
    return {
        .status_bar = {
...
constexpr ESP_Brookesia_PhoneManagerData_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_MANAGER_DATA()
{
    return {
...
constexpr ESP_Brookesia_PhoneStylesheet_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_STYLESHEET()
{
    return {
