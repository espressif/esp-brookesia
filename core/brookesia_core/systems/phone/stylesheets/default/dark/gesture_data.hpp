...
constexpr ESP_Brookesia_GestureIndicatorBarData_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_GestureIndicatorBarData_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_GestureData_t ESP_BROOKESIA_PHONE_DEFAULT_DARK_GESTURE_DATA()
{
    return {
        .detect_period_ms = 20,
        .threshold = {
