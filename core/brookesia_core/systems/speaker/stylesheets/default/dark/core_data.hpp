...
/* Display */
constexpr int ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_DISPLAY_BG_COLOR = 0x1A1A1A;
constexpr ESP_Brookesia_CoreDisplayData ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_DISPLAY_DATA = {
    .background = {
        .color = ESP_BROOKESIA_STYLE_COLOR(ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_DISPLAY_BG_COLOR),
...
/* manager */
constexpr ESP_Brookesia_CoreManagerData_t ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 1,
    },
    .flags = {
...
/* Core */
constexpr const char *ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_INFO_DATA_NAME = "Default Dark";
constexpr ESP_Brookesia_CoreData_t ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_DATA = {
    .name = ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_INFO_DATA_NAME,
    .screen_size = ESP_BROOKESIA_STYLE_SIZE_CIRCLE_PERCENT(100),
    .display = ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_DISPLAY_DATA,
    .manager = ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_CORE_MANAGER_DATA,
};
