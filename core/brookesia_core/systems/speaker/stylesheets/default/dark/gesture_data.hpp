...
constexpr GestureIndicatorBarData ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr GestureIndicatorBarData ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA = {
    .main = {
...
constexpr GestureData ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_DATA = {
    .detect_period_ms = 20,
    .threshold = {
    ...
    .indicator_bars = {
        ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA,
        ESP_BROOKESIA_SPEAKER_DEFAULT_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA,
    },
    .flags = {
        .enable_indicator_bars = {1, 1, 1},
    },
};
