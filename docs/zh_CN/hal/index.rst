...
.. only:: latex
   ...
   .. image:: ../../_static/hal/index_diagram_cn.svg
      :width: 100%
...
.. note::
   ...
   - **方式一（推荐）**：在 ``brookesia_hal_boards`` 的 ``boards/`` 目录下，按照 ``esp_board_manager`` 规范新建开发板子目录并补充配置文件，无需修改适配层代码。详见 :ref:`hal-boards-sec-08`。
