...
.. warning::
   ...
   为了确保 ESP-Brookesia 中示例工程的正常编译，不推荐使用 VSCode 扩展插件安装 ESP-IDF 环境。请参考 `ESP-IDF 编程指南 <https://docs.espressif.com/projects/esp-idf/zh_CN/latest/esp32/get-started/index.html>`__ 完成 ESP-IDF 开发环境的搭建。
