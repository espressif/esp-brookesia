...
.. list-table::
   ...
   * - ``esp32_s3_korvo2_v3``
     - - *ESP32-S3*
       ...
       - *Flash 16MB*
       - *PSRAM 8MB*
     - `ESP32-S3-Korvo-2 V3 <https://docs.espressif.com/projects/esp-adf/en/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2.html>`_
   ...
   * - ``esp_vocat_board_v1_0``
     - - *ESP32-S3*
       ...
       - *Flash 32MB*
       - *PSRAM 16MB*
     - `ESP-VoCat V1.0 <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp-vocat/user_guide_v1.0.html>`_
     - | :cpp:class:`AudioCodecPlayer <esp_brookesia::hal::AudioCodecPlayerIface>`
       | :cpp:class:`AudioCodecRecorder <esp_brookesia::hal::AudioCodecRecorderIface>`
       | :cpp:class:`DisplayPanel <esp_brookesia::hal::DisplayPanelIface>`
       | :cpp:class:`DisplayTouch <esp_brookesia::hal::DisplayTouchIface>`
   ...
   * - ``esp_vocat_board_v1_2``
     - - *ESP32-S3*
       ...
       - *Flash 32MB*
       - *PSRAM 16MB*
     - `ESP-VoCat V1.2 <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp-vocat/user_guide_v1.2.html>`_
     - | :cpp:class:`AudioCodecPlayer <esp_brookesia::hal::AudioCodecPlayerIface>`
       | :cpp:class:`AudioCodecRecorder <esp_brookesia::hal::AudioCodecRecorderIface>`
       | :cpp:class:`DisplayPanel <esp_brookesia::hal::DisplayPanelIface>`
       | :cpp:class:`DisplayTouch <esp_brookesia::hal::DisplayTouchIface>`
   ...
   * - ``esp32_p4_function_ev``
     - - *ESP32-P4*
       ...
       - *Flash 16MB*
       - *PSRAM 32MB*
     - `ESP32-P4-Function-EV-Board <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32p4/esp32-p4-function-ev-board/index.html>`_
     - | :cpp:class:`AudioCodecPlayer <esp_brookesia::hal::AudioCodecPlayerIface>`
       | :cpp:class:`AudioCodecRecorder <esp_brookesia::hal::AudioCodecRecorderIface>`
       | :cpp:class:`DisplayPanel <esp_brookesia::hal::DisplayPanelIface>`
       | :cpp:class:`DisplayTouch <esp_brookesia::hal::DisplayTouchIface>`
   ...
   * - ``esp_mosaico_v1_0``
     - - *ESP32-S31*
       ...
       - *PSRAM 16MB*
       - *Expansion slots*
     - | `Official User Guide <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s31/esp-mosaico/user_guide.html>`_
       | :ref:`Brookesia Adaptation Guide <hal-boards-espressif-mosaico>`
   ...
   * - ``esp_sensair_shuttle``
     - - *ESP32-C5*
       ...
       - *Flash 16MB*
       - *PSRAM 8MB*
     - `ESP Sensair Shuttle <https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c5/esp-sensairshuttle/index.html>`_
     - | :cpp:class:`AudioCodecPlayer <esp_brookesia::hal::AudioCodecPlayerIface>`
       | :cpp:class:`AudioCodecRecorder <esp_brookesia::hal::AudioCodecRecorderIface>`
       | :cpp:class:`DisplayPanel <esp_brookesia::hal::DisplayPanelIface>`
       | :cpp:class:`DisplayTouch <esp_brookesia::hal::DisplayTouchIface>`
