...
[Phone](../src/systems/phone/) 是一个类似于智能手机的系统 UI，在各种不同尺寸和分辨率屏幕的 ESP 开发板 上的运行效果如下所示：
...
[Status Bar](../src/systems/phone/widgets/status_bar/) 用于显示时间、电量、WiFi 状态以及 app 指定图标，运行效果如下图所示，具有以下特点：
...
[App Launcher](../src/systems/phone/widgets/app_launcher/) 用于显示所有已安装 app 的图标，运行效果如下图所示，具有以下特点：
...
[Navigation Bar](../src/systems/phone/widgets/navigation_bar/) 提供导航按键，运行效果如下图所示，具有以下特点：
...
[Recents Screen](../src/systems/phone/widgets/recents_screen/) 用于显示正在运行中的 App，运行效果如下图所示，具有以下特点：
...
[Gesture](../src/systems/phone/widgets/gesture/) 用于获取输入设备的手势信息，具有以下特点：
