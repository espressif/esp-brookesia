...
#   define BROOKESIA_LOGT_IMPL_FUNC(TAG, format, ...) ESP_LOGV(TAG, format _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGD_IMPL_FUNC(TAG, format, ...) ESP_LOGD(TAG, format _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGI_IMPL_FUNC(TAG, format, ...) ESP_LOGI(TAG, format _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGW_IMPL_FUNC(TAG, format, ...) ESP_LOGW(TAG, format _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGE_IMPL_FUNC(TAG, format, ...) ESP_LOGE(TAG, format _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
