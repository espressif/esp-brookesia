...
#   define BROOKESIA_LOGT_IMPL_FUNC(TAG, format, ...) \
        printf("[T] [%10s] " format "\n", TAG _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGD_IMPL_FUNC(TAG, format, ...) \
        printf("[D] [%10s] " format "\n", TAG _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGI_IMPL_FUNC(TAG, format, ...) \
        printf("[I] [%10s] " format "\n", TAG _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGW_IMPL_FUNC(TAG, format, ...) \
        printf("[W] [%10s] " format "\n", TAG _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
...
#   define BROOKESIA_LOGE_IMPL_FUNC(TAG, format, ...) \
        printf("[E] [%10s] " format "\n", TAG _BROOKESIA_LOG_OPTIONAL_ARGS(__VA_ARGS__))
#endif
