...
#   - idf-build-apps build -t esp32s3 --manifest-files=".build-rules.yml" --path='./utils/brookesia_lib_utils/test_apps/describe_helpers' --recursive --build-dir="@v/build_@t_@w"
#
# - Test
