...
#   - idf-build-apps build -t esp32s3 --manifest-files=".build-rules.yml" --path='./utils/brookesia_lib_utils/test_apps/thread_config' --recursive --build-dir="5.5/build_@t_@w"
#
# - Test
#   - ${IDF_PATH}/install.sh --enable-pytest
#   - ${IDF_PATH}/install.sh --enable-test-specific
#   - pytest utils/brookesia_lib_utils/test_apps/thread_config --target esp32s3 --env generic
# '''
