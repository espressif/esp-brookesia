# ESP-Brookesia ELF 运行时后端

* [English Version](./README.md)

## 概述

`brookesia_runtime_elf` 是 ESP-Brookesia 应用包的 ELF 运行时后端。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/runtime/elf.html)。
