...
/**
 * @brief JavaScript runtime backend registered with the runtime manager.
 */
class Backend final : public IRuntimeBackend {
public:
    /**
     * @brief Get the singleton JavaScript backend instance.
     *
     * @return JavaScript backend singleton.
     */
