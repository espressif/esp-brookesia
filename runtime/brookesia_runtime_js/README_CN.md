# ESP-Brookesia JavaScript 运行时后端

* [English Version](./README.md)

## 概述

`brookesia_runtime_js` 是 ESP-Brookesia 应用包的 JavaScript 运行时后端。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/runtime/js.html)。
