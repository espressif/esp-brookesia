# ESP-Brookesia Runtime Manager

* [中文版本](./README_CN.md)

## Overview

`brookesia_runtime_manager` is the common host framework for dynamic runtime application packages.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/runtime/manager.html).
