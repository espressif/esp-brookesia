# ESP-Brookesia Lua Runtime Backend

* [中文版本](./README_CN.md)

## Overview

`brookesia_runtime_lua` is the Lua runtime backend for ESP-Brookesia application packages.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/runtime/lua.html).
