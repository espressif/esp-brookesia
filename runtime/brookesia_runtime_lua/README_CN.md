# ESP-Brookesia Lua 运行时后端

* [English Version](./README.md)

## 概述

`brookesia_runtime_lua` 是 ESP-Brookesia 应用包的 Lua 运行时后端。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/runtime/lua.html)。
