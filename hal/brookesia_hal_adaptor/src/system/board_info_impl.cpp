...
#if !BROOKESIA_HAL_ADAPTOR_SYSTEM_BOARD_INFO_IMPL_ENABLE_DEBUG_LOG
...
BoardInfoImpl::BoardInfoImpl()
    : system::BoardInfoIface(generate_info())
{
...
#endif // BROOKESIA_HAL_ADAPTOR_SYSTEM_ENABLE_BOARD_INFO_IMPL
