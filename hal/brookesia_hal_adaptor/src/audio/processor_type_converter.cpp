...
audio_task_config_t AudioProcessorTypeConverter::convert(const lib_utils::ThreadConfig &config)
{
    return {
...
audio_mixer_gain_config_t AudioProcessorTypeConverter::convert(const AudioProcessorMixerGainConfig &config)
{
    return {
...
audio_playback_config_t AudioProcessorTypeConverter::convert(
...
av_processor_format_id_t AudioProcessorTypeConverter::convert(audio::CodecFormat format)
{
    switch (format) {
...
av_processor_audio_info_t AudioProcessorTypeConverter::convert(const audio::CodecGeneralConfig &config)
{
    return {
...
av_processor_encoder_config_t AudioProcessorTypeConverter::convert(const audio::EncoderDynamicConfig &config)
{
    ...
    case audio::CodecFormat::OPUS: {
        ...
        if (auto *opus_extra = std::get_if<audio::EncoderExtraConfigOpus>(&config.extra)) {
...
av_processor_decoder_config_t AudioProcessorTypeConverter::convert(const audio::DecoderDynamicConfig &config)
{
...
av_processor_afe_config_t AudioProcessorTypeConverter::convert(
...
audio_recorder_config_t AudioProcessorTypeConverter::convert(
...
audio_feeder_config_t AudioProcessorTypeConverter::convert(
