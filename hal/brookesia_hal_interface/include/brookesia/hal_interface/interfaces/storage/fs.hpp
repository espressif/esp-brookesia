...
BROOKESIA_DESCRIBE_STRUCT(StorageFsIface::Info, (), (fs_type, medium_type, mount_point, supports_directories));
BROOKESIA_DESCRIBE_STRUCT(StorageFsIface::Capacity, (), (total_bytes, used_bytes, free_bytes));
