...
typedef struct {
    ...
    esp_err_t (*enter_sleep)(void *driver_data);
    esp_err_t (*exit_sleep)(void *driver_data);
    esp_err_t (*enter_deep_standby)(void *driver_data);
    esp_err_t (*exit_deep_standby)(void *driver_data);
