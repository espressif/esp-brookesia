...
* Added Sleep In / Sleep Out helpers (`esp_lcd_panel_co5300_enter_sleep` / `exit_sleep`)
* Added Deep Standby helpers (`esp_lcd_panel_co5300_enter_deep_standby` / `exit_deep_standby`)
* Local fork used by esp-mosaico-bsp for low-power display paths
