...
esp_err_t esp_lcd_panel_co5300_enter_sleep(esp_lcd_panel_handle_t panel)
{
    ESP_RETURN_ON_FALSE(panel, ESP_ERR_INVALID_ARG, TAG, "invalid panel handle");
    co5300_panel_context_t *panel_ctx = (co5300_panel_context_t *)panel->user_data;
    ESP_RETURN_ON_FALSE(panel_ctx, ESP_ERR_INVALID_STATE, TAG, "panel context not initialized");
    ESP_RETURN_ON_FALSE(panel_ctx->enter_sleep, ESP_ERR_NOT_SUPPORTED, TAG, "sleep control not supported");
    ESP_RETURN_ON_ERROR(panel_ctx->enter_sleep(panel_ctx->driver_data), TAG, "enter sleep failed");
    ESP_LOGI(TAG, "CO5300 entered Sleep In (0x10)");
    return ESP_OK;
}

esp_err_t esp_lcd_panel_co5300_exit_sleep(esp_lcd_panel_handle_t panel)
{
    ESP_RETURN_ON_FALSE(panel, ESP_ERR_INVALID_ARG, TAG, "invalid panel handle");
    co5300_panel_context_t *panel_ctx = (co5300_panel_context_t *)panel->user_data;
    ESP_RETURN_ON_FALSE(panel_ctx, ESP_ERR_INVALID_STATE, TAG, "panel context not initialized");
    ESP_RETURN_ON_FALSE(panel_ctx->exit_sleep, ESP_ERR_NOT_SUPPORTED, TAG, "sleep control not supported");
    ESP_RETURN_ON_ERROR(panel_ctx->exit_sleep(panel_ctx->driver_data), TAG, "exit sleep failed");
    ESP_LOGI(TAG, "CO5300 exited Sleep In (0x11)");
    return ESP_OK;
}

esp_err_t esp_lcd_panel_co5300_enter_deep_standby(esp_lcd_panel_handle_t panel)
{
    ESP_RETURN_ON_FALSE(panel, ESP_ERR_INVALID_ARG, TAG, "invalid panel handle");
    co5300_panel_context_t *panel_ctx = (co5300_panel_context_t *)panel->user_data;
    ESP_RETURN_ON_FALSE(panel_ctx, ESP_ERR_INVALID_STATE, TAG, "panel context not initialized");
    ESP_RETURN_ON_FALSE(panel_ctx->enter_deep_standby, ESP_ERR_NOT_SUPPORTED, TAG, "deep standby not supported");
    ESP_RETURN_ON_ERROR(panel_ctx->enter_deep_standby(panel_ctx->driver_data), TAG, "enter deep standby failed");
    ESP_LOGI(TAG, "CO5300 entered Deep Standby (0x4F)");
    return ESP_OK;
}

esp_err_t esp_lcd_panel_co5300_exit_deep_standby(esp_lcd_panel_handle_t panel)
{
    ESP_RETURN_ON_FALSE(panel, ESP_ERR_INVALID_ARG, TAG, "invalid panel handle");
    co5300_panel_context_t *panel_ctx = (co5300_panel_context_t *)panel->user_data;
    ESP_RETURN_ON_FALSE(panel_ctx, ESP_ERR_INVALID_STATE, TAG, "panel context not initialized");
    ESP_RETURN_ON_FALSE(panel_ctx->exit_deep_standby, ESP_ERR_NOT_SUPPORTED, TAG, "deep standby exit not supported");
    ESP_RETURN_ON_ERROR(panel_ctx->exit_deep_standby(panel_ctx->driver_data), TAG, "exit deep standby failed");
    ESP_LOGI(TAG, "CO5300 left Deep Standby via RESX pulse");
    return ESP_OK;
}
