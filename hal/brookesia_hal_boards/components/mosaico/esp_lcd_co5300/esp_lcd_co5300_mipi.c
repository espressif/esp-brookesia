...
static esp_err_t co5300_mipi_enter_sleep(void *driver_data);
static esp_err_t co5300_mipi_exit_sleep(void *driver_data);
static esp_err_t co5300_mipi_enter_deep_standby(void *driver_data);
static esp_err_t co5300_mipi_exit_deep_standby(void *driver_data);
                                        ...
                                        esp_lcd_panel_handle_t *ret_panel)
{
    ...
    co5300->panel_ctx.enter_sleep = co5300_mipi_enter_sleep;
    co5300->panel_ctx.exit_sleep = co5300_mipi_exit_sleep;
    co5300->panel_ctx.enter_deep_standby = co5300_mipi_enter_deep_standby;
    co5300->panel_ctx.exit_deep_standby = co5300_mipi_exit_deep_standby;
...
static esp_err_t co5300_mipi_enter_deep_standby(void *driver_data)
{
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(co5300->io, CO5300_CMD_DSTBON, &dstb, 1), TAG, "send DSTBON failed");
    return ESP_OK;
}
