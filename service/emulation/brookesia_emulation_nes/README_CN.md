# ESP-Brookesia NES 模拟服务

* [English Version](./README.md)

## 概述

`brookesia_emulation_nes` 是面向 ESP-Brookesia 产品的 NES 模拟服务组件。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/service/emulation/nes.html)。
