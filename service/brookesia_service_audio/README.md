...
`brookesia_service_audio` is an audio service for the ESP-Brookesia ecosystem. It provides audio playback, encoding and decoding, volume control, and playback state management.
