# ESP-Brookesia SNTP 服务

* [English Version](./README.md)

## 概述

`brookesia_service_sntp` 是面向 ESP-Brookesia 产品的网络时间同步服务组件。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/service/sntp.html)。
