# ESP-Brookesia WiFi 服务

* [English Version](./README.md)

## 概述

`brookesia_service_wifi` 是面向 ESP-Brookesia 产品的 Wi-Fi 连接管理服务组件。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/service/wifi.html)。
