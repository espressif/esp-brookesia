...
`brookesia_service_video` is a video service for the ESP-Brookesia ecosystem. It supports local capture encoding and compressed-stream decoding to pixel formats.
