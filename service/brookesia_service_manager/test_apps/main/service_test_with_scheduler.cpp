...
bool ServiceTestWithScheduler::on_init()
{
...
void ServiceTestWithScheduler::on_deinit()
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
bool ServiceTestWithScheduler::on_start()
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
void ServiceTestWithScheduler::on_stop()
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
std::expected<double, std::string> ServiceTestWithScheduler::function_add(double a, double b)
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
std::expected<double, std::string> ServiceTestWithScheduler::function_divide(double a, double b)
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
std::expected<boost::json::object, std::string> ServiceTestWithScheduler::function_test_all_types(
...
std::expected<void, std::string> ServiceTestWithScheduler::function_suspend()
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();

    BROOKESIA_LOGI("Suspending for 1000ms");
...
bool ServiceTestWithScheduler::trigger_event()
{
    BROOKESIA_LOG_TRACE_GUARD_WITH_THIS();
...
BROOKESIA_PLUGIN_REGISTER(ServiceBase, ServiceTestWithScheduler, ServiceTestWithScheduler::SERVICE_NAME);
