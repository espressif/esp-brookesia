...
TEST_CASE("Test Batch Call: sync batch success", "[brookesia][service][batch_call][sync][success]")
{
...
TEST_CASE("Test Batch Call: sync batch fail-fast", "[brookesia][service][batch_call][sync][fail_fast]")
{
...
TEST_CASE("Test Batch Call: sync batch empty", "[brookesia][service][batch_call][sync][empty]")
{
...
TEST_CASE("Test Batch Call: sync batch non-existent function", "[brookesia][service][batch_call][sync][not_exist]")
{
...
TEST_CASE("Test Batch Call: async batch success", "[brookesia][service][batch_call][async][success]")
{
...
TEST_CASE("Test Batch Call: async batch fail-fast", "[brookesia][service][batch_call][async][fail_fast]")
{
...
TEST_CASE("Test Batch Call: async batch non-existent function", "[brookesia][service][batch_call][async][not_exist]")
{
...
TEST_CASE("Test Batch Call: when service not running", "[brookesia][service][batch_call][not_running]")
{
...
TEST_CASE(
    "Test Batch Call: async batch with dedicated scheduler",
    "[brookesia][service][batch_call][async][dedicated_scheduler]"
)
{
