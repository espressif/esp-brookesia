...
constexpr uint32_t WAIT_EVENT_STARTED_TIMEOUT_MS = 200;
constexpr uint32_t WAIT_EVENT_STOPPED_TIMEOUT_MS = 200;
constexpr uint32_t WAIT_EVENT_CONNECTED_TIMEOUT_MS = 7000;
constexpr uint32_t WAIT_EVENT_DISCONNECTED_TIMEOUT_MS = 200;
#else
constexpr uint32_t WAIT_EVENT_STARTED_TIMEOUT_MS = 200;
constexpr uint32_t WAIT_EVENT_STOPPED_TIMEOUT_MS = 200;
constexpr uint32_t WAIT_EVENT_CONNECTED_TIMEOUT_MS = 5000;
constexpr uint32_t WAIT_EVENT_DISCONNECTED_TIMEOUT_MS = 200;
#endif
