...
`brookesia_service_sntp` is an SNTP (Simple Network Time Protocol) service for the ESP-Brookesia ecosystem. It provides NTP server management, time zone settings, and automatic time synchronization.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/service/sntp.html).
