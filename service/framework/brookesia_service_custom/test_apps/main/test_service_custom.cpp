...
static esp_brookesia::service::FunctionReturnSchema make_test_return_schema(
    esp_brookesia::service::FunctionValueType type
)
{
    return esp_brookesia::service::FunctionReturnSchema{
        .type = type,
        .description = "Test return value.",
    };
}

BROOKESIA_TEST_CASE(test_customservice_failed_to_register_function_with_null_handler, "Test CustomService - failed to register function with null handler", "[service][custom][basic]")
{
    ...
    bool success = custom_service.register_function(esp_brookesia::service::FunctionSchema{
        ...
        .return_value = make_test_return_schema(esp_brookesia::service::FunctionValueType::String),
    }, nullptr);
    TEST_ASSERT_EQUAL(false, success);
}

BROOKESIA_TEST_CASE(test_customservice_failed_to_register_function_with_invalid_name, "Test CustomService - failed to register function with invalid name", "[service][custom][basic]")
{
...
BROOKESIA_TEST_CASE(test_customservice_failed_to_register_function_before_startup, "Test CustomService - failed to register function before startup", "[service][custom][basic]")
{
...
BROOKESIA_TEST_CASE(test_customservice_failed_to_register_event_before_startup, "Test CustomService - failed to register event before startup", "[service][custom][basic]")
{
...
BROOKESIA_TEST_CASE(test_customservice_failed_to_register_function_with_the_same_name, "Test CustomService - failed to register function with the same name", "[service][custom][basic]")
{
...
BROOKESIA_TEST_CASE(test_customservice_failed_to_call_non_existing_function, "Test CustomService - failed to call non-existing function", "[service][custom][function][reference]")
{
...
BROOKESIA_TEST_CASE(test_customservice_standard_case_1, "Test CustomService - standard case 1", "[service][custom][function][reference]")
{
...
BROOKESIA_TEST_CASE(test_customservice_standard_case_2, "Test CustomService - standard case 2", "[service][custom][function][reference]")
{
...
BROOKESIA_TEST_CASE(test_customservice_register_function_with_lvalue_schema_and_handler, "Test CustomService - register function with lvalue schema and handler", "[service][custom][function][lvalue]")
{
    ...
    esp_brookesia::service::FunctionSchema schema{
        ...
        .return_value = make_test_return_schema(esp_brookesia::service::FunctionValueType::Number),
    };
    std::function<esp_brookesia::service::FunctionResult(const esp_brookesia::service::FunctionParameterMap &args)> handler =
    [](const esp_brookesia::service::FunctionParameterMap & args) -> esp_brookesia::service::FunctionResult {
...
BROOKESIA_TEST_CASE(test_customservice_lvalue_function_registration_copies_schema_and_handler_lifetime, "Test CustomService - lvalue function registration copies schema and handler lifetime", "[service][custom][function][lvalue][lifecycle]")
{
...
BROOKESIA_TEST_CASE(test_customservice_lvalue_function_handler_remains_valid_after_scope_exit, "Test CustomService - lvalue function handler remains valid after scope exit", "[service][custom][function][lvalue][lifecycle]")
{
...
BROOKESIA_TEST_CASE(test_customservice_lambda_function_as_function_handler, "Test CustomService - lambda function as function handler", "[service][custom][function][reference][lambda]")
{
...
BROOKESIA_TEST_CASE(test_customservice_std_function_as_function_handler, "Test CustomService -  std:function as function handler", "[service][custom][function][reference][std:function]")
{
...
BROOKESIA_TEST_CASE(test_customservice_std_function_as_function_handler_with_reference_parameter, "Test CustomService -  std:function as function handler with reference parameter", "[service][custom][function][reference][std:function][reference]")
{
...
BROOKESIA_TEST_CASE(test_customservice_class_static_function_as_function_handler, "Test CustomService -  class static function as function handler", "[service][custom][function][reference][class][function]")
{
...
BROOKESIA_TEST_CASE(test_customservice_error_case_for_lambda_function_with_reference_capture, "Test CustomService -  error case for lambda function with reference capture", "[service][custom][function][reference][lambda][reference]")
{
...
BROOKESIA_TEST_CASE(test_customservice_free_function_as_handler, "Test CustomService - free function as handler", "[service][custom][callable][free_func]")
{
...
BROOKESIA_TEST_CASE(test_customservice_functor_as_handler, "Test CustomService - functor as handler", "[service][custom][callable][functor]")
{
...
BROOKESIA_TEST_CASE(test_customservice_member_function_as_handler, "Test CustomService - member function as handler", "[service][custom][callable][member_func]")
{
...
BROOKESIA_TEST_CASE(test_customservice_std_bind_as_handler, "Test CustomService - std::bind as handler", "[service][custom][callable][bind]")
{
...
BROOKESIA_TEST_CASE(test_customservice_lambda_with_mutable_capture, "Test CustomService - lambda with mutable capture", "[service][custom][callable][lambda_mutable]")
{
...
BROOKESIA_TEST_CASE(test_customservice_duplicate_function_keeps_original_handler, "Test CustomService - duplicate function keeps original handler", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_failed_to_register_function_with_name_too_long, "Test CustomService - failed to register function with name too long", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_handler_returns_failure, "Test CustomService - handler returns failure", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_function_with_no_parameters, "Test CustomService - function with no parameters", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_optional_parameter_uses_default_value, "Test CustomService - optional parameter uses default value", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_missing_required_parameter, "Test CustomService - missing required parameter", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_invalid_parameter_type, "Test CustomService - invalid parameter type", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_unknown_parameter_is_rejected, "Test CustomService - unknown parameter is rejected", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_multiple_functions_registered, "Test CustomService - multiple functions registered", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_boolean_parameter, "Test CustomService - Boolean parameter", "[service][custom][param_types]")
{
    ...
    custom_service.register_function(esp_brookesia::service::FunctionSchema{
        ...
        .return_value = make_test_return_schema(esp_brookesia::service::FunctionValueType::Boolean),
    }, [](const esp_brookesia::service::FunctionParameterMap & args) -> esp_brookesia::service::FunctionResult {
...
BROOKESIA_TEST_CASE(test_customservice_multiple_parameters_string_number_boolean, "Test CustomService - multiple parameters (String, Number, Boolean)", "[service][custom][param_types]")
{
...
BROOKESIA_TEST_CASE(test_customservice_object_parameter, "Test CustomService - Object parameter", "[service][custom][param_types]")
{
...
BROOKESIA_TEST_CASE(test_customservice_array_parameter, "Test CustomService - Array parameter", "[service][custom][param_types]")
{
...
BROOKESIA_TEST_CASE(test_customservice_call_with_functionparametermap, "Test CustomService - call with FunctionParameterMap", "[service][custom][call_overload]")
{
...
BROOKESIA_TEST_CASE(test_customservice_call_with_vector_of_parameters, "Test CustomService - call with vector of parameters", "[service][custom][call_overload]")
{
...
BROOKESIA_TEST_CASE(test_customservice_async_call_returns_expected_result, "Test CustomService - async call returns expected result", "[service][custom][call_overload][async]")
{
...
BROOKESIA_TEST_CASE(test_customservice_async_call_for_missing_function_fails, "Test CustomService - async call for missing function fails", "[service][custom][call_overload][async]")
{
...
BROOKESIA_TEST_CASE(test_customservice_handler_returns_no_data, "Test CustomService - handler returns no data", "[service][custom][reliability]")
{
...
BROOKESIA_TEST_CASE(test_customservice_handler_returns_data_without_schema_fails, "Test CustomService - handler return data without schema fails", "[service][custom][reliability][return_schema]")
{
    BROOKESIA_LOGI("=== Test CustomService - handler return data without schema fails ===");
    ...
    custom_service.register_function(esp_brookesia::service::FunctionSchema{
        .name = "func_unexpected_data",
        .description = "returns data without declaring return schema",
        .parameters = {},
    }, [](const esp_brookesia::service::FunctionParameterMap &) -> esp_brookesia::service::FunctionResult {
        return esp_brookesia::service::FunctionResult{
            .success = true,
            .data = std::string("unexpected"),
        };
    });

    auto result = custom_service.call_function_sync("func_unexpected_data", boost::json::object{}, 1000);
    TEST_ASSERT_FALSE(result.success);
    TEST_ASSERT_TRUE(result.error_message.find("returned data") != std::string::npos);
}

BROOKESIA_TEST_CASE(test_customservice_handler_returns_wrong_type_fails, "Test CustomService - handler return wrong type fails", "[service][custom][reliability][return_schema]")
{
    BROOKESIA_LOGI("=== Test CustomService - handler return wrong type fails ===");
    ...
    custom_service.register_function(esp_brookesia::service::FunctionSchema{
        .name = "func_wrong_return_type",
        .description = "returns string while declaring number",
        .parameters = {},
        .return_value = make_test_return_schema(esp_brookesia::service::FunctionValueType::Number),
    }, [](const esp_brookesia::service::FunctionParameterMap &) -> esp_brookesia::service::FunctionResult {
        return esp_brookesia::service::FunctionResult{
            .success = true,
            .data = std::string("wrong"),
        };
    });

    auto result = custom_service.call_function_sync("func_wrong_return_type", boost::json::object{}, 1000);
    TEST_ASSERT_FALSE(result.success);
    TEST_ASSERT_TRUE(result.error_message.find("invalid data type") != std::string::npos);
}

// ========== Event tests ==========

BROOKESIA_TEST_CASE(test_customservice_register_event, "Test CustomService - register event", "[service][custom][event]")
{
...
BROOKESIA_TEST_CASE(test_customservice_register_event_with_lvalue_schema, "Test CustomService - register event with lvalue schema", "[service][custom][event][lvalue]")
{
...
BROOKESIA_TEST_CASE(test_customservice_lvalue_event_schema_is_copied_after_registration, "Test CustomService - lvalue event schema is copied after registration", "[service][custom][event][lvalue][lifecycle]")
{
...
BROOKESIA_TEST_CASE(test_customservice_subscribe_non_existing_event, "Test CustomService - subscribe non-existing event", "[service][custom][event]")
{
...
BROOKESIA_TEST_CASE(test_customservice_multiple_subscribers_receive_same_event, "Test CustomService - multiple subscribers receive same event", "[service][custom][event]")
{
...
BROOKESIA_TEST_CASE(test_customservice_publish_event_with_missing_item_fails, "Test CustomService - publish event with missing item fails", "[service][custom][event]")
{
...
BROOKESIA_TEST_CASE(test_customservice_publish_event_with_invalid_item_type_fails, "Test CustomService - publish event with invalid item type fails", "[service][custom][event]")
{
...
BROOKESIA_TEST_CASE(test_customservice_dynamic_registration_and_schema_query, "Test CustomService - dynamic registration and schema query", "[service][custom][dynamic_query]")
{
...
BROOKESIA_TEST_CASE(test_customservice_unregister_function, "Test CustomService - unregister function", "[service][custom][unregister][function]")
{
...
BROOKESIA_TEST_CASE(test_customservice_unregister_event, "Test CustomService - unregister event", "[service][custom][unregister][event]")
{
