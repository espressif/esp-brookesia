...
BROOKESIA_TEST_CASE(test_dependency_basic_dependency_and_order, "Test Dependency: basic dependency and order", "[brookesia][service][dependency][basic]")
{
...
BROOKESIA_TEST_CASE(test_dependency_circular_dependency_detection, "Test Dependency: circular dependency detection", "[brookesia][service][dependency][circular]")
{
...
BROOKESIA_TEST_CASE(test_dependency_multi_level_chain, "Test Dependency: multi-level chain", "[brookesia][service][dependency][chain]")
{
...
BROOKESIA_TEST_CASE(test_dependency_diamond_dependency, "Test Dependency: diamond dependency", "[brookesia][service][dependency][diamond]")
{
...
BROOKESIA_TEST_CASE(test_dependency_missing_dependency_error, "Test Dependency: missing dependency error", "[brookesia][service][dependency][missing]")
{
...
BROOKESIA_TEST_CASE(test_dependency_complex_dependency_graph, "Test Dependency: complex dependency graph", "[brookesia][service][dependency][complex]")
{
