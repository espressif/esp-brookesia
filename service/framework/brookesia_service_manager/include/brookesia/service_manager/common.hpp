...
public:
    explicit ScopedCallContext(CallContext context);
    ScopedCallContext(const ScopedCallContext &) = delete;
    ScopedCallContext &operator=(const ScopedCallContext &) = delete;
    ScopedCallContext(ScopedCallContext &&other) noexcept;
    ScopedCallContext &operator=(ScopedCallContext &&other) noexcept;
    ~ScopedCallContext();

private:
    CallContext previous_context_;
    bool active_ = false;
};
