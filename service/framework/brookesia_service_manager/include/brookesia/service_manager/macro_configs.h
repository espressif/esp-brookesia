...
/* RPC relies on Boost.Asio sockets and is disabled for the browser wasm MVP. */
#if !defined(BROOKESIA_SERVICE_MANAGER_ENABLE_RPC)
#   if defined(CONFIG_BROOKESIA_SERVICE_MANAGER_WASM_ENABLE_RPC)
#       define BROOKESIA_SERVICE_MANAGER_ENABLE_RPC CONFIG_BROOKESIA_SERVICE_MANAGER_WASM_ENABLE_RPC
#   elif defined(__EMSCRIPTEN__)
#       define BROOKESIA_SERVICE_MANAGER_ENABLE_RPC (0)
#   else
#       define BROOKESIA_SERVICE_MANAGER_ENABLE_RPC (1)
#   endif
#endif
