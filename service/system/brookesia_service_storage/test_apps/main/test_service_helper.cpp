...
BROOKESIA_TEST_CASE(
    helper_bool_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with bool",
    "[service][storage][helper][bool]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_bool");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with bool ===");
    ...
    {
        auto result = StorageHelper::save_key_value(test_namespace, test_key, true, CALL_FUNCTION_SYNC_TIMEOUT_MS);
        ...
        auto get_result = StorageHelper::get_key_value<bool>(test_namespace, test_key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    {
        auto result = StorageHelper::save_key_value(test_namespace, test_key, false, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Clean up
    {
        auto result = StorageHelper::erase_keys(test_namespace, {}, CALL_FUNCTION_SYNC_TIMEOUT_MS);
        TEST_ASSERT_TRUE_MESSAGE(result.has_value(), result.has_value() ? "Failed to erase keys" : ("Failed to erase keys: " + result.error()).c_str());
    }
}

BROOKESIA_TEST_CASE(
    helper_int32_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with int32_t",
    "[service][storage][helper][int32_t]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_int32_t");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with int32_t ===");
    ...
    // Test int32_t
    {
        ...
        auto result = StorageHelper::save_key_value(test_namespace, key, value_to_save, CALL_FUNCTION_SYNC_TIMEOUT_MS);
        ...
        auto get_result = StorageHelper::get_key_value<int32_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test uint32_t
    {
        ...
        auto get_result = StorageHelper::get_key_value<uint32_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test int (signed int)
    {
        ...
        auto get_result = StorageHelper::get_key_value<int>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
...
BROOKESIA_TEST_CASE(
    helper_small_integer_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with small integers (<32 bits)",
    "[service][storage][helper][s_int]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_s_int");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with small integers (<32 bits) ===");
    ...
    // Test int8_t (8-bit signed integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<int8_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test uint8_t (8-bit unsigned integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<uint8_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test int16_t (16-bit signed integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<int16_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test uint16_t (16-bit unsigned integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<uint16_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test char (typically 8-bit)
    {
        ...
        auto get_result = StorageHelper::get_key_value<char>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test signed char (8-bit signed)
    {
        ...
        auto get_result = StorageHelper::get_key_value<signed char>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test unsigned char (8-bit unsigned)
    {
        ...
        auto get_result = StorageHelper::get_key_value<unsigned char>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test short (typically 16-bit)
    {
        ...
        auto get_result = StorageHelper::get_key_value<short>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test unsigned short (typically 16-bit unsigned)
    {
        ...
        auto get_result = StorageHelper::get_key_value<unsigned short>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
...
BROOKESIA_TEST_CASE(
    helper_large_integer_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with large integers (>32 bits)",
    "[service][storage][helper][large_int]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_large_int");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with large integers (>32 bits) ===");
    ...
    // Test int64_t (64-bit signed integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<int64_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test uint64_t (64-bit unsigned integer)
    {
        ...
        auto get_result = StorageHelper::get_key_value<uint64_t>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test long long (typically 64-bit)
    {
        ...
        auto get_result = StorageHelper::get_key_value<long long>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test unsigned long long (typically 64-bit unsigned)
    {
        ...
        auto get_result = StorageHelper::get_key_value<unsigned long long>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // On 64-bit platforms, long is 64-bit, so it should use serialization
    {
        ...
        auto get_result = StorageHelper::get_key_value<long>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test unsigned long (platform-dependent, typically 32 or 64 bits)
    {
        ...
        auto get_result = StorageHelper::get_key_value<unsigned long>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
...
BROOKESIA_TEST_CASE(
    helper_floating_point_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with floating point",
    "[service][storage][helper][float]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_float");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with floating point ===");
    ...
    // Test float (32-bit floating point)
    {
        ...
        auto get_result = StorageHelper::get_key_value<float>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Test double (64-bit floating point)
    {
        ...
        auto get_result = StorageHelper::get_key_value<double>(test_namespace, key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
...
BROOKESIA_TEST_CASE(
    helper_string_roundtrip,
    "Test Storage Helper - save_key_value and get_key_value with string",
    "[service][storage][helper][string]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_string");
    BROOKESIA_LOGI("=== Test Storage Helper - save_key_value and get_key_value with string ===");
    ...
    auto result = StorageHelper::save_key_value(test_namespace, test_key, test_value, CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    auto get_result = StorageHelper::get_key_value<std::string>(test_namespace, test_key, CALL_FUNCTION_SYNC_TIMEOUT_MS);
...
BROOKESIA_TEST_CASE(
    helper_mixed_types_workflow,
    "Test Storage Helper - mixed types workflow",
    "[service][storage][helper][mixed]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_mixed");
    BROOKESIA_LOGI("=== Test Storage Helper - mixed types workflow ===");
    ...
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "bool_val", true, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to save bool");
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "int_val", 12345, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to save int");
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "string_val", std::string("test_string"), CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to save string");
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "uint32_val", 4294967295U, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to save uint32_t");

    // Retrieve and verify all values
    {
        auto bool_result = StorageHelper::get_key_value<bool>(test_namespace, "bool_val", CALL_FUNCTION_SYNC_TIMEOUT_MS);
        TEST_ASSERT_TRUE_MESSAGE(bool_result.has_value(), "Failed to get bool");
        TEST_ASSERT_TRUE(bool_result.value());

        auto int_result = StorageHelper::get_key_value<int>(test_namespace, "int_val", CALL_FUNCTION_SYNC_TIMEOUT_MS);
        TEST_ASSERT_TRUE_MESSAGE(int_result.has_value(), "Failed to get int");
        TEST_ASSERT_EQUAL_INT(12345, int_result.value());

        auto string_result = StorageHelper::get_key_value<std::string>(test_namespace, "string_val", CALL_FUNCTION_SYNC_TIMEOUT_MS);
        ...
        auto uint32_result = StorageHelper::get_key_value<uint32_t>(test_namespace, "uint32_val", CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    // Update values
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "bool_val", false, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to update bool");
    TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "int_val", 54321, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to update int");
    ...
    TEST_ASSERT_FALSE_MESSAGE(StorageHelper::get_key_value<bool>(test_namespace, "bool_val", CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "bool_val should be erased");
    TEST_ASSERT_FALSE_MESSAGE(StorageHelper::get_key_value<int>(test_namespace, "int_val", CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "int_val should be erased");
    TEST_ASSERT_FALSE_MESSAGE(StorageHelper::get_key_value<std::string>(test_namespace, "string_val", CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "string_val should be erased");
    TEST_ASSERT_FALSE_MESSAGE(StorageHelper::get_key_value<uint32_t>(test_namespace, "uint32_val", CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "uint32_val should be erased");
}

BROOKESIA_TEST_CASE(
    helper_error_handling,
    "Test Storage Helper - error handling",
    "[service][storage][helper][error]"
)
{
    BROOKESIA_TIME_PROFILER_SCOPE("test_storage_helper_error");
    BROOKESIA_LOGI("=== Test Storage Helper - error handling ===");
    ...
    {
        auto result = StorageHelper::get_key_value<int>(test_namespace, "non_key", CALL_FUNCTION_SYNC_TIMEOUT_MS);
    ...
    {
        TEST_ASSERT_TRUE_MESSAGE(StorageHelper::save_key_value(test_namespace, "wrong_type_key", 42, CALL_FUNCTION_SYNC_TIMEOUT_MS).has_value(), "Failed to save int");
        ...
        auto result = StorageHelper::get_key_value<bool>(test_namespace, "wrong_type_key", CALL_FUNCTION_SYNC_TIMEOUT_MS);
