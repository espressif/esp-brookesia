# ESP-Brookesia 表情表达服务

* [English Version](./README.md)

## 概述

`brookesia_expression_emote` 是用于表情、动画和事件消息展示的表达服务组件。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/service/expression/emote.html)。
