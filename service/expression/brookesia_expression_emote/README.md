# ESP-Brookesia Emote Expression Service

* [中文版本](./README_CN.md)

## Overview

`brookesia_expression_emote` is the expression service for emoji, animation, and event message presentation.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/service/expression/emote.html).
