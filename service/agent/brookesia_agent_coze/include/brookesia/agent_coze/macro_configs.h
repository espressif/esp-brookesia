...
/**
 * @brief Enable automatic plugin registration for the Coze agent component.
 */
...
/**
 * @brief Default log tag used by the Coze agent component.
 */
...
#if !defined(BROOKESIA_AGENT_COZE_ENABLE_AUTO_LOAD_DATA)
#   if defined(CONFIG_BROOKESIA_AGENT_COZE_ENABLE_AUTO_LOAD_DATA)
#       define BROOKESIA_AGENT_COZE_ENABLE_AUTO_LOAD_DATA  CONFIG_BROOKESIA_AGENT_COZE_ENABLE_AUTO_LOAD_DATA
#   else
#       define BROOKESIA_AGENT_COZE_ENABLE_AUTO_LOAD_DATA  (1)
#   endif
#endif
