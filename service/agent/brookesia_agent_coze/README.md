...
`brookesia_agent_coze` is the Coze platform adapter for ESP-Brookesia agent applications.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/service/agent/coze.html).
