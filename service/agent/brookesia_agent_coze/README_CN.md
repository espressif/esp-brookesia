...
`brookesia_agent_coze` 是面向 ESP-Brookesia 智能体应用的 Coze 平台适配组件。

更多信息请参考 [ESP-Brookesia 编程指南](https://docs.espressif.com/projects/esp-brookesia/zh_CN/latest/service/agent/coze.html)。
