...
`brookesia_agent_xiaozhi` is the XiaoZhi platform adapter for ESP-Brookesia agent applications.

For more information, see the [ESP-Brookesia Programming Guide](https://docs.espressif.com/projects/esp-brookesia/en/latest/service/agent/xiaozhi.html).
