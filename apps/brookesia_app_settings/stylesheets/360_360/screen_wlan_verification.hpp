...
constexpr SettingsUI_ScreenWlanVerificationData SETTINGS_UI_360_360_SCREEN_WLAN_VERIFICATION_DATA()
{
    return {
        ...
        .keyboard = {
            .size = ESP_BROOKESIA_STYLE_SIZE_RECT_W_PERCENT(100, 220),
            .align_bottom_offset = 0,
            .top_pad = 0,
            .bottom_pad = 40,
            .left_pad = 20,
            .right_pad = 20,
            .main_background_color = ESP_BROOKESIA_STYLE_COLOR(0x000000),
            .normal_button_background_color = ESP_BROOKESIA_STYLE_COLOR(0x000000),
            .special_button_background_color = ESP_BROOKESIA_STYLE_COLOR(0x000000),
            .ok_button_disabled_background_color = ESP_BROOKESIA_STYLE_COLOR_WITH_OPACITY(0xFF3034, 80),
            .ok_button_enabled_background_color = ESP_BROOKESIA_STYLE_COLOR(0xFF3034),
            .text_font = ESP_BROOKESIA_STYLE_FONT_SIZE(24),
